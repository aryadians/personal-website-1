// Import Images
import unikama from "../../assets/unikama.png";
      ...
      <div className="flex md:flex-row flex-col justify-between md:items-center">
        <div className="flex items-center gap-5">
          ...
          <div className="md:text-left text-right ">
            <h3 className="md:text-3xl font-bold">Universitas PGRI Kanjuruhan Malang</h3>
      ...
      <div className="my-5 flex flex-col gap-5 font-medium">
        ...
        <ul>
          <li className="font-medium md:text-lg text-xs md:leading-normal leading-5">
            ⚪ Curriculum Core Team - Google Developer Student Clubs of Kanjuruhan
            University
          </li>
          <li className="font-medium md:text-lg text-xs md:leading-normal leading-5">
            ⚪ Public Relation - Programming Kanjuruhan University
          </li>
          <li className="font-medium md:text-lg text-xs md:leading-normal leading-5">
            ⚪ Front End dev - Riki Course - Prakerja 2023
          </li>
        </ul>
      </div>
    </section>
